...
import { styles } from './SuccessScreenVerifyNumberStyles';
...
import { SuccessVerifyNumberHooks } from './SuccessScreenVerifyNumberHooks';

const SuccessScreenVerifyNumber = () => {
  const {message, userAppBar, handleGoBack, navigateToEditProfile} =
    SuccessVerifyNumberHooks();
  return (
...
export default SuccessScreenVerifyNumber;
