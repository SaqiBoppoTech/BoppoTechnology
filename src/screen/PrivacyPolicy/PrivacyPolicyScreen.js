      ...
      <ScrollView style={styles.mainView}>
        <View>
          ...
          <Text style={styles.text}>
            ...
            (including credit card numbers or bank account details) email
            ...
            {'\n'}
            {'\n'}
            RangePlus.com [Re: Privacy Compliance Officer] RangePlus Limited,
            Unit 2 Pilton Industrial Estate, 46 Pitlake, Croydon, CR0 3RA,
            United Kingdom
          </Text>
        </View>
      </ScrollView>
