...
const CategoryDetailScreen = ({route}) => {
  ...
  const {renderItem, handleGoBack, navigateToFilterPage, renderItemTopTab} =
    CategoryDetailHooks();
  return (
    <View style={styles.main}>
      ...
      <View>
        <FlatList
          horizontal
          data={STATIC_DATA.categoryDetailTopTabData}
      ...
      <View style={styles.listWrapper}>
        <FlatList
          ...
          renderItem={()=> <View style={{backgroundColor:'red'}}></View>}
