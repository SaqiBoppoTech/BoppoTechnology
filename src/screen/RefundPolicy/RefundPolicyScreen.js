      ...
      <ScrollView style={styles.mainView}>
        <View>
          ...
          <Text style={styles.text}>
            ...
            {'\n'}
            {'\n'}
            Our policy lasts 14 days. If 14 days have gone by since receipt of
            the parcel, unfortunately we can’t offer you a refund or exchange.
            {'\n'}
            {'\n'}
            ...
            (if applicable) - Book with obvious signs of use - CD, DVD, VHS
            tape, software, video game, cassette tape, or vinyl record that has
            been opened - Any item not in its original condition, is damaged or
            missing parts for reasons not due to our error - Any item that is
            returned more than 30 days after delivery
            {'\n'}
            {'\n'}
            Refunds (if applicable) Once your return is received and inspected,
            ...
            {'\n'}
            {'\n'}
            Exchanges (if applicable) We only replace items if they are
            defective or damaged. If you need to exchange it for the same item,
            send us an email at support@rangeplus.com and send your item to:
