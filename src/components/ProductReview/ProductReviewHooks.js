  ...
  const renderItem = ({item}) => (
    <View style={styles.viewWrapper}>
      ...
      <View style={styles.flexWrapContainer}>
        <Image
          source={GlobalImage.Set3}
          style={styles.squareImage}
        />
        <Image
          source={GlobalImage.Set2}
          style={styles.squareImage}
        />
        <View style={styles.flexContainer}>
          <Text style={styles.reviewDes}>
            <Text style={{...styles.reviewDes, fontFamily: Fonts.MANROPE_BOLD}}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
              tincidunt amet egestas tempor facilisi.
            </Text>
            Venenatis lorem mattis faucibus netus sit gravida odio tortor nibh.
            Eget eleifend odio mauris quam nunc enim. Eget vestibulum.
          </Text>
        </View>
      </View>
    </View>
  ...
  const ratingbar = ({item}) => (
    <View style={styles.ratingMainView}>
      ...
      <StarSvg
        height={CHANGE_BY_MOBILE_DPI(17)}
        width={CHANGE_BY_MOBILE_DPI(17)}
        style={styles.starMarginHorizontalContainer}
      />
