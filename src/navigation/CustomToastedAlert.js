...
const CustomToastedAlert = () => {
    ...
    const ToastedAlert = () => {
        return(
            <Animated.View style={styles.positionContainer}>
                <Animated.View style={[styles.toastedContainer, {
                opacity: fadeAnim,
            }]}>
                    <Text style={styles.toastedFontStyle}>{alertVisibility && alertVisibility.toastedAlertText}</Text>
                </Animated.View>
            </Animated.View>
        )
    }
    ...
    return (
     <>
     {alertVisibility.condition && <ToastedAlert/>}
     </>
    )
};
