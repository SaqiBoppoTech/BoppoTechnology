...
const FocusAwareStatusBar = ({ barColor = Colors.BLACK, barStyle = "default", isLightBar = false, isTopSpace = true }) => {
	...
	return isAndroid
		...
		// null
		:
		<View style={{ paddingTop: isTopSpace ? insets.top : 0, backgroundColor: !isTopSpace ? "#00000000" : barColor }} >
			<StatusBar backgroundColor={!isTopSpace ? "#00000000" : barColor} transculent={true} barStyle={isLightBar ? 'light-content' : 'dark-content'} />
		</View>
};
